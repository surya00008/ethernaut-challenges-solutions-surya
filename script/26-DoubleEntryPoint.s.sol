...
import "../src/26-DoubleEntryPoint/DoubleEntryPoint.sol";

/**
 * @title Challenge 26 Solution Script
 * @notice Solution script for DoubleEntryPoint challenge
 */
contract DoubleEntryPointSolution is Script {
    ...
    function run() external {
        ...
        console.log("Solving Challenge 26: DoubleEntryPoint");
